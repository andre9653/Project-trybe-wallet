...
Neste projeto o objetivo é desenvolver uma carteira de controle de gastos com conversor de moedas, ao utilizar essa aplicação um usuário deverá ser capaz de:
...
Deve desenvolver uma aplicação em React que use Redux como ferramenta de manipulação de estado.
...
Esse projeto foi criado pela instituição de ensino Trybe, e o desenvolvimento de todo o codigo por mim.